...
require_once ABSPATH . 'public_html/wp-admin/includes/admin.php';
...
if ( WP_NETWORK_ADMIN ) {
	require ABSPATH . 'public_html/wp-admin/network/menu.php';
} elseif ( WP_USER_ADMIN ) {
	require ABSPATH . 'public_html/wp-admin/user/menu.php';
} else {
	require ABSPATH . 'public_html/wp-admin/menu.php';
}
...
if ( isset( $plugin_page ) ) {
	if ( $page_hook ) {
		...
		if ( ! isset( $_GET['noheader'] ) ) {
			require_once ABSPATH . 'public_html/wp-admin/admin-header.php';
		}
	...
	require_once ABSPATH . 'public_html/wp-admin/admin-footer.php';
	...
	require_once ABSPATH . 'public_html/wp-admin/includes/upgrade.php';
